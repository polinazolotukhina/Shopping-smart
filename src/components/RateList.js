...
class RateList extends React.Component {
  ...
  render() {
    ...
    const data = Object.keys(items).reduce(
      (newObj, key) =>
    ...
    return (
      <div>
        <OverlayTrigger
          ...
          onClick={() => {
            this.props.actions.sortData('rating', false);
          }}
        >
        ...
        <OverlayTrigger
          ...
          onClick={() => {
            this.props.actions.sortData('rating', true);
          }}
        >
        ...
        <OverlayTrigger
          ...
          onClick={() => {
            this.props.actions.sortData('times', true);
          }}
        >
        ...
        <OverlayTrigger
          ...
          onClick={() => {
            this.props.actions.sortData('times', false);
          }}
        >
        ...
        <OverlayTrigger
          ...
          onClick={() => {
            this.props.actions.sortData('price', true);
          }}
        >
        ...
        <OverlayTrigger
          ...
          onClick={() => {
            this.props.actions.sortData('price', false);
          }}
        >
